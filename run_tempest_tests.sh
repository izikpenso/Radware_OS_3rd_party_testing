...
sshpass -p $VM_SSH_PASSWORD ssh -o "StrictHostKeyChecking no" $VM_SSH_USER@$VM_IP 'sed -i "s/#lbaas_entity_delete_timeout=10/lbaas_entity_delete_timeout=1000/g" /opt/stack/tempest/etc/tempest.conf'
