...
sshpass -p $VM_SSH_PASSWORD ssh -o "StrictHostKeyChecking no" $M_SSH_USER@$VM_IP 'sed -i "s/timeout = 300:/timeout = 3000:/g" /opt/stack/neutron-lbaas/neutron_lbaas/tests/tempest/v2/api/base.py'
