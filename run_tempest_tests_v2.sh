...
sshpass -p $VM_SSH_PASSWORD ssh -o "StrictHostKeyChecking no" $VM_SSH_USER@$VM_IP 'cd; cd devstack; source openrc admin demo; nova service-list >> ~/lbaas_v2_tempest_tests.log'
