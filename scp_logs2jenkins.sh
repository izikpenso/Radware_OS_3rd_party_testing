...
sshpass -p $VM_SSH_PASSWORD scp $VM_SSH_USER@$VM_IP:~/\{q_log.txt,stack.sh.log.*,vdirect_history.log,vdirect_lbaas_cfg.log,lbaas_v2_tempest_tests.log,lbaas_v1_tempest_tests.log} $LOG_FOLDER_NAME/.
