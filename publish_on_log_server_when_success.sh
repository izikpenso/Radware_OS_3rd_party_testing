...
sshpass -p $LOG_SERVER_PASSWORD scp $LOG_FOLDER_NAME/stack.sh.log.*.summary.* $LOG_FOLDER_NAME/tempest.log $LOG_SERVER_USER@$LOG_SERVER_IP:/oslogs/RADWARE-CI-LOGS/$LOG_FOLDER_NAME/.
